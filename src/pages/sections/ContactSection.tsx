...
export default function ContactSection() {
    ...
    <a className={styles.email} href="mailto:marcusnirgi@gmail.com">
        <svg className={styles.contact_icon} width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M22.9167 6.25L12.5 13.5417L2.08333 6.25" stroke="#DCDCDC" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    ...
    <div className={styles.main_contact_container}>
        ...
        <a href="https://www.linkedin.com/in/marcus-nirgi" className={styles.contact_icon}>
            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M6.25 9.375H2.08333V21.875H6.25V9.375Z" stroke="#DCDCDC" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M4.16667 6.25001C5.31726 6.25001 6.25 5.31727 6.25 4.16668C6.25 3.01608 5.31726 2.08334 4.16667 2.08334C3.01607 2.08334 2.08333 3.01608 2.08333 4.16668C2.08333 5.31727 3.01607 6.25001 4.16667 6.25001Z" stroke="#DCDCDC" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </a>
    </div>
    )
